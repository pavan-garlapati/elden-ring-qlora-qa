# 🗡️ Elden Ring QA — Domain-Specific Question Answering with QLoRA
...
│   ├── elden_ring_boss_stats_clean.csv  # 142 boss combat stats
│   ├── elden_ring_weapon.csv      # 307 weapon scaling data
│   ├── armors.csv                 # 723 armor pieces
│   ├── incantations.csv           # 129 incantations
│   ├── sorceries.csv              # 84 sorceries
│   ├── npcs.csv                   # 109 NPCs
│   ├── locations.csv              # 286 locations
│   ├── creatures.csv              # 205 creatures
│   ├── skills.csv                 # 257 skills
│   └── ashesOfWar.csv             # 117 ashes of war
...
python extract_lore.py          # → master_lore.json
python fuse_data.py             # → elden_ring_enriched.json  
python generate_qa.py           # → elden_ring_final_train.jsonl
```
...
- **Cross-entity analysis**: Boss vulnerability → weapon recommendation pipeline
...
1. [Kaggle — Ultimate Elden Ring with Shadow of the Erdtree DLC](https://www.kaggle.com/datasets/pedroaltobelli/ultimate-elden-ring-with-shadow-of-the-erdtree-dlc)
2. [GitHub — Impalers-Archive](https://github.com/ividyon/Impalers-Archive) (DLC text dump)
3. [GitHub — Carian-Archive](https://github.com/AsteriskAmpersand/Carian-Archive) (Base game text dump)
